...
void ApplicationManager::ExecuteAction(ActionType ActType) 
{
	...
	case TO_PLAY_MODE:
		pAct = new SwitchPlayAction(this);// temporary till you made its action class (CHANGE THIS LATTER)
		break;
	...
	case TO_DESIGN_MODE:
		pAct = new SwitchDesignAction(this);// temporary till you made its action class (CHANGE THIS LATTER)
		break;
